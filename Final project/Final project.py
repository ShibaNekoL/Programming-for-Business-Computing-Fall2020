...
import individual_android  # 個人android的py檔
import individual_ios  # 個人ios系統的py檔
...
def individual():
    ...
    while not back:
        ...
        if Data.img == '字數':
            ...
            screen.blit(Data.surf_a, (20, 450))  # 圖片擺放位置
            ...
            screen.blit(Data.surf_a, (-30, 250))  # 圖片擺放位置
            screen.blit(Data.surf_d, (370, 250))
            pg.display.flip()
